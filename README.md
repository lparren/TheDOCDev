...
# Changes
## 2026-04-10
- OAS Developer feature was not working. For some reason jq was not installed, added it to the dockerfile.
- added dns to compose file for oas. We need to be able to cummunicate with github so we can commit our semantic models.
- added a folder for my own demo applications (which are not included)
## 2026-03-27
